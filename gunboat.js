...
var MODEL_URL =
  'http://www.onlydreaming.net/files/gunboatonline/type23-2.kmz';
...
Truck.prototype.finishInit = function(kml) {
  ...
  me.teleportTo(50.5705, -2.44, 0.4);
...
Truck.prototype.tick = function() {
  ...
  if (leftButtonDown || rightButtonDown) {
    var TURN_SPEED_MIN = 10.0;  // deg/sec
    var TURN_SPEED_MAX = 20.0;  // deg/sec
  ...
  // Slow down if approaching shore
  if (groundAlt > 0) {
    me.vel[0] = me.vel[0]*0.99;
    me.vel[1] = me.vel[1]*0.99;
  }
...
Truck.prototype.showPopup = function(message) {
  var me = this;
  me.popupTimer = 1.0;
